			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
					...
					<div class="card-body">
						...
						<form action="<?php base_url('admin/Pendataan/add') ?>" method="post" enctype="multipart/form-data" >
                        <div class="form-group">
								<label for="nik">NIK</label>
								<input class="form-control <?php echo form_error('nik') ? 'is-invalid':'' ?>"
								 type="text" name="nik" placeholder="NIK anda" />
                        ...
                        <div class="form-group">
								...
								<input class="form-control <?php echo form_error('nomor_kk') ? 'is-invalid':'' ?>"
								 type="number" name="nomor_kk" min="0" placeholder="Nomor KK" />
								<div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
								...
								<input class="form-control <?php echo form_error('tgl_lahir') ? 'is-invalid':'' ?>"
								 type="date" name="tgl_lahir" min="0" placeholder="Tanggal Lahir" />
								<div class="invalid-feedback">
