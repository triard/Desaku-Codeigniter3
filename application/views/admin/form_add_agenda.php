						...
						<form action="<?php base_url('admin/agenda/add_agenda') ?>" method="post" enctype="multipart/form-data" >
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('agenda') ? 'is-invalid':'' ?>"
								 type="text" name="agenda" placeholder="nama agenda" />
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('tempat') ? 'is-invalid':'' ?>"
								 type="text" name="tempat" id="tempat"  placeholder="Tempat" />
								<div class="invalid-feedback">
                            ...
                            <div class="form-group">
								...
								<input class="form-control <?php echo form_error('jam') ? 'is-invalid':'' ?>"
								 type="time" name="jam" id="jam"  placeholder="Jam" />
								<div class="invalid-feedback">
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('koordinator') ? 'is-invalid':'' ?>"
								 type="text" name="koordinator" id="koordinator"  placeholder="Koordinator" />
								<div class="invalid-feedback">
