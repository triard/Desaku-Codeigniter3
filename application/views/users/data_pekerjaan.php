...
<body>
  ...
  <div class="container" style="margin-top:30px">
        ...
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item dropdown active">
            ...
            <div class="dropdown-menu">
              ...
              <a class="dropdown-item active" href="<?php echo  base_url('User/data_pekerjaan') ?>">Data Pekerjaan</a>
    ...
    <div class="row">
      <div class="col-sm-8">
        <br><br>
        <h2>Data Demografi Berdasar Pekerjaan</h2>
        <br>
          ...
          <table class="table">
            ...
            <tbody>
              <tr>
                ...
                <?php $this->load->view('admin/_partials/chart_pekerjaan', $chart_data2); ?>
              </tr>
            </tbody>
          </table>
        </div>
